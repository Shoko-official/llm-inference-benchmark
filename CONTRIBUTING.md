...
```text
docs/inference/<issue-id>-short-name
feat/inference/<issue-id>-short-name
fix/inference/<issue-id>-short-name
```
...
* no inference benchmark content appears before the right milestone;
...
Do not introduce benchmark claims as final content unless they are backed by
